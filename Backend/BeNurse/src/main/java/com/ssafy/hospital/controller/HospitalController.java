...
public class HospitalController {
	...
	public ResponseEntity<Hospital> getHospitalById(@RequestParam("ID") long ID) {
	...
	public ResponseEntity<Void> deleteHospitalById(@RequestParam("ID") long ID) {
	    Optional<Hospital> hospital = hospitalRepo.findById(ID);
	...
	public ResponseEntity<Void> updateHospitalById(@RequestBody Hospital updatedHospital){
	...
	public ResponseEntity<Hospital> registHospital(Hospital hospital) {
